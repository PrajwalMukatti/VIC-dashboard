		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "vicstart_integration",
									"targetURL": "#vicstartintegration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"vicstartintegration-display": {
								"semanticObject": "vicstartintegration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=vicstartintegration",
									"url": sap.ui.require.toUrl("vicstartintegration")
								}
							}
						}
					}
