...
sap.ui.define([
	...
	SmartFilterBar.prototype.onBeforeRendering = function () {
		// Apply FESR Semantic
		this._applyFESRSemantic(this._oSearchButton, "sc:sfbGo");
		this._applyFESRSemantic(this._oHideShowButton, "sc:sfbShowHideToggle");
		this._applyFESRSemantic(this._oClearButtonOnFB, "sc:sfbClear");
		this._applyFESRSemantic(this._oRestoreButtonOnFB, "sc:sfbRestore");
	...
	SmartFilterBar.prototype._checkForValues = function(oData, oFilterItem, oControl) {
		...
		if (oData && oFilterItem && oControl) {
			...
			if (!oFilterItem.data("isCustomField")) {
				...
				if (oFieldMetadata && oFieldMetadata.hasValidation === false) {
					hasValidation = oFieldMetadata.hasValidation;
				}
	...
	SmartFilterBar.prototype._getVisibleControlsLoadingPromises = function () {
		...
		this.determineMandatoryFilterItems().forEach(function (oFilterItem) {
			...
			if (
				oControl &&
				!oFilterItem.data("isCustomField") && // This is not a custom field
	 ...
	 * @public
	 * @returns {sap.ui.comp.smartfilterbar.SmartFilterBar.SearchAllowed} an empty object indicates that all is fine and the search can be triggered. an object with the property mandatory indicates
	...
	SmartFilterBar.prototype._validateMandatoryFields = function() {
		var bFilled = true, aFilterItems = this.determineMandatoryFilterItems(), oFilterItem, oData = this.getFilterData(false, true), iLen = 0, oControl;
