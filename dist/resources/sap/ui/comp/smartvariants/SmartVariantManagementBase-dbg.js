...
sap.ui.define([
	...
	SmartVariantManagementBase.prototype.setEnabled = function (bEnabled) {
		this.setProperty("enabled", bEnabled);
		var aContent = this._oVM.oVariantLayout.getContent();
		if (!bEnabled) {
			...
			//aContent[1].addStyleClass("sapMVarMngmtClickable");
