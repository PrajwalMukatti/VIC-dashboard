...
sap.ui.define([
	...
	SmartTable.prototype._triggerUI5ClientExport = function(bExportAs) {
		var that = this;
		var aSheetColumns, fnEventHandler, fnGetLabel, mExportSettings, oLibrary, oRowBinding;
		...
		fnEventHandler = function(oEvent) {
			...
			aFilters.forEach(function(oFilter) {
				...
				var oColumn = that._getColumnByKey(sPropertyName) || that._getColumnFromP13nMap(sPropertyName);
